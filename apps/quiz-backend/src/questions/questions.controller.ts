...
export class QuestionsController {
  ...
  @Post('check')
  async check(@Body() body: { questionId: number; selectedOptionId: number; elapsedMs?: number }) {
    const res = await this.service.checkAnswer(body.questionId, body.selectedOptionId);
