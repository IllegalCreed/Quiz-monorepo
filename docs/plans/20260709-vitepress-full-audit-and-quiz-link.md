...
| 指标                                  | 数量 |
| ------------------------------------- | ---: |
| Quiz 分类叶子（本地 `categories.ts`） |  412 |
| 测试题链接总数                        |  327 |
| 可匹配到分类叶子                      |  326 |
| 无匹配分类叶子                        |    1 |

当前 Quiz 前端支持精确匹配、compact slug 匹配和保守的前缀边界匹配，因此 `MUI（Material UI）→ MUI`、`PDF.js / pdfjs-dist → PDF.js`、`Everything Claude Code（ECC）→ Everything Claude Code` 这类标题扩展都可落到正确叶子。

唯一未匹配项：

- `src/zh/frontend-develop-tools/testing/test-quality/ai-era-testing/index.md`：链接参数 `ai-时代如何测试`，本地分类树与题库 JSON 中暂无对应叶子/题目。该页应作为后续内容缺口处理；不在本次审计中擅自变更分类结构或导入生产库。

## 速查审计

| 目录                                           | 内容页 | 合规 | 缺失 | 位置不合规 |
| ---------------------------------------------- | ------ | ---- | ---- | ---------- |
| base/language                                  | 207    | 207  | 0    | 0          |
| frontend-develop-tools/testing                 | 133    | 133  | 0    | 0          |
| web-advanced/js-extension                      | 105    | 21   | 84   | 0          |
| web-advanced/language                          | 98     | 98   | 0    | 0          |
| base/network                                   | 88     | 81   | 0    | 7          |
| architecture/micro-frontend                    | 56     | 56   | 0    | 0          |
| frontend-develop-tools/static-analysis         | 56     | 56   | 0    | 0          |
| frontend-framework/components                  | 54     | 25   | 27   | 2          |
| frontend-framework/document                    | 50     | 10   | 40   | 0          |
| frontend-develop-tools/optimization            | 47     | 38   | 0    | 9          |
| mobile-desktop/miniprogram                     | 46     | 46   | 0    | 0          |
| frontend-develop-tools/documentation-generator | 41     | 41   | 0    | 0          |
| frontend-framework/meta                        | 41     | 26   | 15   | 0          |
| base/browser                                   | 40     | 40   | 0    | 0          |
| frontend-framework/ui                          | 38     | 25   | 13   | 0          |
| frontend-toolchain/bundler                     | 35     | 7    | 28   | 0          |
| mobile-desktop/mobile-framework                | 34     | 34   | 0    | 0          |
| large-language-model/tools                     | 30     | 14   | 16   | 0          |
| engineering/devops                             | 26     | 22   | 4    | 0          |
| mobile-desktop/desktop-framework               | 26     | 26   | 0    | 0          |
| frontend-framework/ssg                         | 24     | 11   | 13   | 0          |
| engineering/iac                                | 23     | 21   | 2    | 0          |
| engineering/monorepo                           | 22     | 21   | 1    | 0          |
| frontend-develop-tools/online-editor           | 22     | 17   | 5    | 0          |
| web-advanced/package-manager                   | 20     | 4    | 16   | 0          |
| frontend-develop-tools/ide                     | 19     | 10   | 9    | 0          |
| frontend-framework/others                      | 19     | 9    | 10   | 0          |
| frontend-framework/state                       | 18     | 12   | 6    | 0          |
| engineering/release                            | 17     | 16   | 1    | 0          |
| frontend-toolchain/build                       | 17     | 5    | 12   | 0          |
| frontend-toolchain/compiler                    | 15     | 3    | 12   | 0          |
| frontend-develop-tools/version-control         | 13     | 13   | 0    | 0          |
| engineering/container                          | 12     | 12   | 0    | 0          |
| engineering/deps                               | 11     | 11   | 0    | 0          |
| frontend-framework/composables                 | 11     | 7    | 4    | 0          |
| web-advanced/module                            | 10     | 2    | 8    | 0          |
| frontend-framework/router                      | 9      | 6    | 3    | 0          |
| large-language-model/models                    | 9      | 3    | 6    | 0          |
| frontend-visualization/canvas                  | 7      | 7    | 0    | 0          |
| frontend-visualization/d3                      | 7      | 7    | 0    | 0          |
| frontend-visualization/echarts                 | 7      | 7    | 0    | 0          |
| frontend-visualization/svg                     | 7      | 7    | 0    | 0          |
| frontend-visualization/animejs                 | 6      | 6    | 0    | 0          |
| frontend-visualization/antv-g2                 | 6      | 6    | 0    | 0          |
| frontend-visualization/antv-g6                 | 6      | 6    | 0    | 0          |
| frontend-visualization/antv-x6                 | 6      | 6    | 0    | 0          |
| frontend-visualization/babylon                 | 6      | 6    | 0    | 0          |
| frontend-visualization/cesium                  | 6      | 6    | 0    | 0          |
| frontend-visualization/chartjs                 | 6      | 6    | 0    | 0          |
| frontend-visualization/dnd-kit                 | 6      | 6    | 0    | 0          |
| frontend-visualization/fabric                  | 6      | 6    | 0    | 0          |
| frontend-visualization/framer-motion           | 6      | 6    | 0    | 0          |
| frontend-visualization/gsap                    | 6      | 6    | 0    | 0          |
| frontend-visualization/konva                   | 6      | 6    | 0    | 0          |
| frontend-visualization/leaflet                 | 6      | 6    | 0    | 0          |
| frontend-visualization/lottie                  | 6      | 6    | 0    | 0          |
| frontend-visualization/mapbox-maplibre         | 6      | 6    | 0    | 0          |
| frontend-visualization/mermaid                 | 6      | 6    | 0    | 0          |
| frontend-visualization/pixi                    | 6      | 6    | 0    | 0          |
| frontend-visualization/recharts                | 6      | 6    | 0    | 0          |
| frontend-visualization/waapi                   | 6      | 6    | 0    | 0          |
| frontend-visualization/webgl                   | 6      | 6    | 0    | 0          |
| frontend-visualization/webgpu                  | 6      | 6    | 0    | 0          |
| large-language-model/skills                    | 6      | 2    | 4    | 0          |
| frontend-visualization/sortablejs              | 5      | 5    | 0    | 0          |
| frontend-visualization/three                   | 5      | 4    | 1    | 0          |
| (root)                                         | 4      | 0    | 4    | 0          |
...
- `src/zh/frontend-develop-tools/online-editor/codepen/reference.md`
- `src/zh/frontend-develop-tools/online-editor/codesandbox/reference.md`
- `src/zh/frontend-develop-tools/online-editor/expo-snack/reference.md`
- `src/zh/frontend-develop-tools/online-editor/framework-playground/reference.md`
- `src/zh/frontend-develop-tools/online-editor/stackblitz/reference.md`
...
- `src/zh/start.md`
- `src/zh/web-advanced/js-extension/axios/guide-line/advanced.md`
- `src/zh/web-advanced/js-extension/axios/guide-line/base.md`
- `src/zh/web-advanced/js-extension/axios/guide-line/expert.md`
- `src/zh/web-advanced/js-extension/axios/reference.md`
...
- `src/zh/web-advanced/js-extension/ky/guide-line/advanced.md`
- `src/zh/web-advanced/js-extension/ky/guide-line/base.md`
- `src/zh/web-advanced/js-extension/ky/guide-line/expert.md`
- `src/zh/web-advanced/js-extension/ky/reference.md`
...
- `src/zh/web-advanced/js-extension/ofetch/guide-line/advanced.md`
- `src/zh/web-advanced/js-extension/ofetch/guide-line/base.md`
- `src/zh/web-advanced/js-extension/ofetch/guide-line/expert.md`
- `src/zh/web-advanced/js-extension/ofetch/reference.md`
...
- `src/zh/base/network/net-cors/guide-line/jsonp-proxy.md`
- `src/zh/base/network/net-cors/guide-line/samesite-coop-coep.md`
- `src/zh/base/network/net-ip-routing/guide-line/routing-router-gateway.md`
- `src/zh/base/network/net-ip-routing/guide-line/subnet-cidr.md`
- `src/zh/base/network/net-link-lan/guide-line/switch.md`
- `src/zh/base/network/net-link-lan/guide-line/vlan.md`
- `src/zh/base/network/net-transport/guide-line/tcp-reliable.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/angular-devtools/guide-line/injector-tree.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/angular-devtools/guide-line/profiler.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/firefox-devtools/guide-line/accessibility.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/firefox-devtools/guide-line/fonts-shapes-compat.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/redux-devtools/guide-line/integration.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/redux-devtools/guide-line/time-travel.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/safari-web-inspector/guide-line/ios-remote-debugging.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/vue-devtools/guide-line/inspector-graph.md`
- `src/zh/frontend-develop-tools/optimization/browser-tools/vue-devtools/guide-line/pinia-router.md`
- `src/zh/frontend-framework/components/astryx/getting-started.md`
- `src/zh/frontend-framework/components/astryx/guide-line.md`
